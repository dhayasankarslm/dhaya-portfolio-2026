...
import { useRef, createElement, type ElementType, forwardRef, type ForwardedRef } from "react";
...
const BlurText = forwardRef<HTMLElement, BlurTextProps>(
  ({ text, as: Tag = "p", className = "" }, ref) => {
